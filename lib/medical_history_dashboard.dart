  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          _buildMedicalHistoryCard(
              ...
              appointmentDate: "19/04/19",
              medicalNote: "Mild Fever and Cold"),
          _buildMedicalHistoryCard(
              hospitalName: "AIIMS Hospital",
              appointmentDate: "19/04/19",
              medicalNote:
                  "Dengue Fever detected. Low platelet count. Medicines include: ABC, XYZ"),
          _buildMedicalHistoryCard(
              hospitalName: "Cytecare",
              appointmentDate: "19/04/19",
              medicalNote: "Mild Fever and Cold"),
          _buildMedicalHistoryCard(
              hospitalName: "Cytecare",
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: 'Upload your report',
      ),
    );
  }

  Widget _buildMedicalHistoryCard(
      {String hospitalName, String appointmentDate, String medicalNote}) {
    return Padding(
